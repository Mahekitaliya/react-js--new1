            ...
            <div className="grid grid-cols-5 gap-2   flex-wrap mt-5">
              <div className="flex">
                <div className="footer-logo">
                  <a href="#" className=''>
                    <img src="https://wp.hixstudio.net/ninico/wp-content/themes/ninico/assets/img/logo/logo.png" alt="Girl in a jacket" className='mb-8'></img>
                  </a>
        ...
        <div className='container mx-auto flex items-center justify-between'>
          ...
          <div className='flex'>
            ...
            <div className='flex pl-2'>
                <img src="https://wp.hixstudio.net/ninico/wp-content/uploads/2023/01/f-google.jpg" alt="" className='w-24 h-8 mr-2'/>

                <img src="https://wp.hixstudio.net/ninico/wp-content/uploads/2023/01/f-app.jpg" alt="" className='w-24 h-8'/>
            </div>
          </div>
        </div>
